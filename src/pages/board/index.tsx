...
const Board: React.FC = () => {
  ...
  // 当前工具选择
  const [optionsType, setOptionsType] = useState<string>(CANVAS_ELE_TYPE.FREE_LINE);
  ...
  return (
    <div>
      <OptionsCard board={board} optionsType={optionsType} setOptionsType={setOptionsType} />
      <canvas
